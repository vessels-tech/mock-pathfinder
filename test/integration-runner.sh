...
psql <<'EOSQL'
    DROP DATABASE IF EXISTS "mock_pathfinder_integration";
	  CREATE DATABASE "mock_pathfinder_integration";
EOSQL

export MOPF_DATABASE_URI="postgres://${POSTGRES_USER}:${POSTGRES_PASSWORD}@${POSTGRES_HOST}:15432/mock_pathfinder_integration"
